...
- **Conformance Classes:**
  ...
  - `https://api.stacspec.org/v1.0.0-rc.1/async-export` (required)
- **Scope:** STAC API - Core
...
```json
{
  ...
  "status": "pending",
  "status_url": "[https://api.example.com/export/exp-a1b2c3d4](https://api.example.com/export/exp-a1b2c3d4)",
...
```json
{
  ...
  "status": "completed",
  "status_url": "[https://api.example.com/export/exp-a1b2c3d4](https://api.example.com/export/exp-a1b2c3d4)",
  "download_url": "[https://data.example.com/downloads/exp-a1b2c3d4.parquet](https://data.example.com/downloads/exp-a1b2c3d4.parquet)",
